...
rooms regardless of device. Matches are real-time over WebSockets, so your
...
|------------|-------|--------|
| `Samuel.Praxis_Math.premium` | $4.99 | Sets `isPremium=true` permanently, removing token gating from competition mode |
